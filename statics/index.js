...
const TAG_RULES = [
  ...
  { tag: 'GenRec',         keywords: ['generative recommendation','generative recommender','recommender system','personalized recommendation','sequential recommendation'] },
  { tag: 'GenSearch',      keywords: ['generative search','generative retrieval','neural search','llm search','search engine','answer generation'] },
  { tag: 'POI Rec',        keywords: ['poi recommendation','poi search','point of interest','location recommendation','geospatial recommendation','spatial-temporal recommendation'] },
