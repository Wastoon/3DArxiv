...
TAG_RULES = [
    ...
    ("AIGC",           ["aigc","generative model","image generation","video generation","text-to-image"]),
    ("LLM Agent",      ["llm agent","language model agent","tool use","agentic","decision making","planning"]),
    ("Reward Model",   ["reward model","preference optimization","preference learning","rlhf","rlaif"]),
    ("Spatial AI",     ["spatial ai","spatial intelligence","spatial reasoning","spatial understanding",
                         "spatial world model","3d scene understanding"]),
    ("Spatial Agent",  ["spatial agent","spatial agents","embodied agent","3d agent",
                         "vision-language navigation","object navigation"]),
    ("GenRec",         ["generative recommendation","generative recommender","recommender system",
                         "personalized recommendation","sequential recommendation"]),
    ("GenSearch",      ["generative search","generative retrieval","neural search","llm search",
                         "search engine","answer generation"]),
    ("POI Rec",        ["poi recommendation","poi search","point of interest","location recommendation",
                         "geospatial recommendation","spatial-temporal recommendation"]),
